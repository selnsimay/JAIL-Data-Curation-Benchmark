...
│   ├── (INPUT) neo4j_files/
|       └── (INPUT) neo4j-community-4.4.40        # User must provide (Neo4j installation + 
|    Reactome Database migration can be found here: https://reactome.org/dev/graph-database#GetStarted)
├── data/
